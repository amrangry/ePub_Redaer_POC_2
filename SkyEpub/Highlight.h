...
@interface Highlight : NSObject {
    ...
    BOOL forSearch;
    /** tells this highlight is used temporary - don't use the property */
    BOOL isTemporary;
}
...
@property (nonatomic,retain) NSString* note,*text,*datetime;
...
@property BOOL isNote,forSearch,isTemporary;
